...
class SongsLocalDataSource private constructor(resolver: ContentResolver) : SongDataSource.Local {
    private val songLocalData: SongLocalData = SongLocalData(resolver)
